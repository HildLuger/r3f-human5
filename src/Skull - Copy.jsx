...
export default function Skull() {
  ...
  // timer to fade out tooltip after 5 seconds
  useEffect(() => {
    let timer1;
    if (hover1) {
      timer1 = setTimeout(() => setHover1(false), 10000);
      setHover2(false);
      setHover3(false);
    }
  ...
  useEffect(() => {
    let timer2;
    if (hover2) {
      timer2 = setTimeout(() => setHover2(false), 10000);
      setHover1(false);
      setHover3(false);
    }
  ...
  useEffect(() => {
    let timer3;
    if (hover3) {
      timer3 = setTimeout(() => setHover3(false), 10000);
      setHover1(false);
      setHover2(false);
    }
